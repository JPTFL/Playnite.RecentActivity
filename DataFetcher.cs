...
namespace RecentActivity
{
    ...
    public class GameActivityDataFetcher
    {
        private static Guid _extensionId = Guid.Parse("afbb1a0d-04a1-4d0c-9afa-c6e42ca855b4");
        private readonly ILogger _logger = LogManager.GetLogger("GameActivityDataFetcher");
        private readonly string _activityPath;

        public GameActivityDataFetcher(string extensionsDataPath)
        {
